...
namespace FaultApp2.Server.Migrations
{
    public partial class flyaway : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(nullable: false),
                    MakinaGrubuId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MakinaGrubuId = table.Column<int>(nullable: false),
                    MakinaId = table.Column<int>(nullable: true),
                    ...
                    FixById = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Faults_Operators_FixById",
                        column: x => x.FixById,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Faults_Operators_OperatorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Faults_FixById",
                table: "Faults",
                column: "FixById");

            migrationBuilder.CreateIndex(
                name: "IX_Faults_MakinaGrubuId",
                table: "Faults",
                column: "MakinaGrubuId");

            migrationBuilder.CreateIndex(
                name: "IX_Faults_MakinaId",
                table: "Faults",
                column: "MakinaId");

            migrationBuilder.CreateIndex(
                name: "IX_Faults_OperatorId",
                table: "Faults",
                column: "OperatorId");
